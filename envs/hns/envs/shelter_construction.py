...
from onpolicy.envs.hns.modules.walls import WallScenarios
from onpolicy.envs.hns.modules.objects import Boxes, Cylinders, LidarSites
...
class ShelterRewardWrapper(gym.Wrapper):
    ...
    def __init__(self, env, num_rays_per_side=30, reward_scale=1):
        ...
        for i in range(num_rays_per_side):
            ...
            new_start_points = [(sp_min_xy + sp_offset, sp_min_xy, 0), (sp_max_xy, sp_min_xy + sp_offset, 0),
                                (sp_max_xy - sp_offset, sp_max_xy, 0), (sp_min_xy, sp_max_xy - sp_offset, 0)]
...
def ShelterConstructionEnv(args,
    ...
    env = ShelterRewardWrapper(env, num_rays_per_side=num_rays_per_side, reward_scale=shelter_reward_scale)
