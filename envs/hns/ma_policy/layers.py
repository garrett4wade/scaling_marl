...
def residual_sa_block(inp,
                      mask,
                      heads,
                      n_embd,
                      layer_norm=False,
                      post_sa_layer_norm=False,
                      n_mlp=1,
                      qk_w=0.125,
                      v_w=0.125,
                      post_w=0.125,
...
def self_attention(inp, mask, heads, n_embd, layer_norm=False, qk_w=1.0, v_w=0.01, scope='', reuse=False):
    '''
...
def circ_conv1d(inp, **conv_kwargs):
    ...
    assert 'kernel_size' in conv_kwargs, "Kernel size needs to be specified for circular convolution layer."
